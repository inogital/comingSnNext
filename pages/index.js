...
const ComingSoon = () => {
    ...
    const commingSoonTime = () => {
        let endTime = new Date("September 17, 2021 17:00:00 PDT");
    ...
    return (
        <>
            ...
            <style jsx>{`
                ...
                .sidebar-contact-info .info-list li {
                ...
                .sidebar-contact-info .info-list li:last-child {
                    margin-bottom: 0;
                }
                .sidebar-contact-info .info-list li a {
                    color: var(--paragraph-color);
                }
               .sidebar-contact-info .info-list li a:hover {
                    color: var(--main-color);
                }
                .sidebar-contact-info .info-list li i {
                    position: absolute;
                    left: 0;
                    top: 2px;
                    font-size: var(--font-size);
                ...
                .sidebar-contact-info .info-list li .ri-mail-line {
                    color: #0064FB;
                }
                .sidebar-contact-info .info-list li .ri-map-pin-line {
                    color: #0064FB;
                }
                // Responsive Style
