                                    ...
                                    <li className="nav-item">
                                        <Link href="#">
                                            <a onClick={e => e.preventDefault()} className="nav-link">
                                                Solutions <i className='ri-add-line'></i>
                                            </a>
                                        </Link>
                                        ...
                                        <ul className="dropdown-menu">
                                            <li className="nav-item">
                                                <Link href="/services" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Education</a>
                                                </Link>
                                            </li> 

                                            <li className="nav-item">
                                                <Link href="/services-2" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Business</a>
                                                </Link>
                                            </li> 
                                            <li className="nav-item">
                                                <Link href="/apps" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Web and Mobile Applications</a>
                                                </Link>
                                            </li> 
                                            <li className="nav-item">
                                                <Link href="/google-services" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Google Services</a>
                                                </Link>
                                            </li> 
                                            <li className="nav-item">
                                                <Link href="/networking" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Networking and IT Infrastructure</a>
                                                </Link>
                                            </li> 

                                            <li className="nav-item">
                                                <Link href="/services-3" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Devices</a>
                                                </Link>
                                            </li> 
                                        </ul>
                                    </li>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="sidebar-content">
                                <h3>Inogital</h3>
                                <p>To inogitalise is to achieve digitisation by means of innovation. We are meant to step up and do things differently on how the world imagined it will be done differently.</p>
                            ...
                            <div className="sidebar-contact-info">
                                ...
                                <ul className="info-list">
                                    <li>
                                        ...
                                        <a href="tel:+27679177445">(+27) 67 917 7445</a>
                                    </li>
                                    
                                    <li>
                                        <i className="ri-mail-line"></i> 
                                        <a href="mailto:info@inogital.com">info@inogital.com</a>
                                    </li>

                                    <li>
                                        <i className="ri-map-pin-line"></i> 
                                        112 Balfour St <br /> Salt River, Cape Town, 7925.
                                    </li>
                                </ul>
                            </div>
